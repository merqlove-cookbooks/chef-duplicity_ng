...
when 'debian'
  default['duplicity_ng']['source']['dev']['packages'] = %w(python-dev librsync-dev libffi-dev)
...
when 'rhel', 'fedora', 'suse'
  ...
  default['duplicity_ng']['source']['dev']['packages'] = %w(python-devel librsync-devel libffi-devel)
  default['duplicity_ng']['source']['python']['packages'] = %w(python-lockfile python-setuptools python-GnuPGInterface python-paramiko)
end
